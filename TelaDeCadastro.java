            ...
            new ActionListener() {
                ...
                public void actionPerformed(ActionEvent event) {
                    if (txtNome.getText().trim().length() == 0) {
                        lblNotificacoes.setText("É necessario digital algo no campo Nome. Por favor, digite um caracter válido no campo para prosseguir");
                        txtNome.requestFocus();
                        return;
                    }

                    if (txtEmail.getText().trim().length() == 0) {
                        lblNotificacoes.setText("É necessario digital algo no campo Email. Por favor, digite um caracter válido no campo para prosseguir");
                        txtEmail.requestFocus();
                        return;
                    }
                    
                    if (String.valueOf(txtSenha.getPassword()).trim().length() == 0) {
                        lblNotificacoes.setText("É necessario digital algo no campo Senha. Por favor, digite um caracter válido no campo para prosseguir");
                    ...
                    try {
                        ...
                        lblNotificacoes.setText("Ops!, Ocorreu um problema e não sera possivel cadastrar no momento. Por favor, tente novamente mais tarde.");
                        System.err.println("Se liga no erro:" + e);
                    }
                }    
            }
        );
